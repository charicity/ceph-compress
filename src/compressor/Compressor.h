...
public:
  ...
  static boost::optional<CompressionAlgorithm>
  get_comp_alg_type(std::string_view s);

  static const char *get_comp_mode_name(int m);
  static boost::optional<CompressionMode>
  get_comp_mode_type(std::string_view s);
  ...
  virtual int compress(const ceph::bufferlist &in, ceph::bufferlist &out,
                       boost::optional<int32_t> &compressor_message) = 0;
  ...
  virtual int decompress(ceph::bufferlist::const_iterator &p,
                         size_t compressed_len, ceph::bufferlist &out,
                         boost::optional<int32_t> compressor_message) = 0;
